	...
	<div class="awsm-job-main awsm-job-single-content">		
		<div class="awsm-job-container">
			...
			<div style="width: 100%; text-align: center;">
				<a class="btn-volver" style="border-radius: 24px 24px 24px 24px;font-family: 'Open Sans', Sans-serif; font-size: 16px; font-weight: 600; text-transform: capitalize; color: #FFFFFF;background-color: #2342ac;padding: 12px 30px 12px 30px;display: inline-block;text-align: center;  overflow: hidden;transition: all .4s;" href="/empleos">
					Volver
				</a>
			</div>
