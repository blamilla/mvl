				...
				if ( $display ) {
					...
					if ( ! empty( $terms ) ) {
						...
						if ( $display_label ) {
							...
							if(strpos($spec_name, "Job Category") !== false) {
								$spec_label = '<span class="awsm-job-specification-label"><strong>Categoría: </strong></span>';
							}
							
							if(strpos($spec_name, "Job Type") !== false) {
								$spec_label = '<span class="awsm-job-specification-label"><strong>Tipo: </strong></span>';
							}
							
							if(strpos($spec_name, "Job Location") !== false) {
								$spec_label = '<span class="awsm-job-specification-label"><strong>Ubicación: </strong></span>';
							}
